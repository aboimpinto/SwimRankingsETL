        ...
        for filename in FILES:
            ...
            if swimmers:
                execute_values(cur,
                    ...
                    """,
                    list(swimmers.values()), page_size=500)
            ...
            cur.execute("UPDATE processing_log SET status='success', result_count = (SELECT COUNT(*) FROM results r JOIN meets m ON r.meet_id=m.id WHERE m.meet_id=%s), error_msg=NULL WHERE file_name=%s", (meet_id_str, filename))
